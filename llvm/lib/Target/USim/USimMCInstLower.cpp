...
//#include "MCTargetDesc/USimMCExpr.h"
...
bool llvm::lowerUSimMachineInstrToMCInst(const MachineInstr *MI, MCInst &OutMI,
                                         AsmPrinter &AP) {
  OutMI.setOpcode(MI->getOpcode());

  for (const MachineOperand &MO : MI->operands()) {
    MCOperand MCOp;
    if (LowerUSimMachineOperandToMCOperand(MO, MCOp, AP))
